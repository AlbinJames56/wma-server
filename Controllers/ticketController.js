...
const HandleTicketGeneration = async (data) => {
  ...
  function renderHeading(text) {
    doc
      .font("Helvetica-Bold")
      .fontSize(18)
      .text(text, { align: "center", underline: true, lineGap: 10 });
  }
  ...
  function renderSectionLabel(label) {
    doc
      .font("Helvetica-Bold")
      .fontSize(12)
      .text(label, { align: "left", lineGap: 6 });
  }
  ...
  function renderTerms(termsText) {
    doc
      .font("Helvetica-Bold")
      .fontSize(12)
      .text("Terms and Conditions", { align: "center", lineGap: 8 });
    doc
      .font("Helvetica")
      .fontSize(10)
      .text(termsText, { align: "left", indent: 10, lineGap: 6 });
  }
  ...
  for (const [key, value] of Object.entries(ticketCount)) {
    ...
    for (let i = 0; i < value; i++) {
      ...
      doc
        .fontSize(16)
        .font("Helvetica-Bold")
        .text(eventName, { align: "center", lineGap: 8 });
      doc.moveDown(1);
      ...
      doc.moveDown(2);
      renderSectionLabel(
        "USE OF THIS TICKET MEANS THAT THE ATTENDEE IS BOUND BY ALL EVENT ORGANISER TERMS AND CONDITIONS"
      );
      doc.moveDown(3);
